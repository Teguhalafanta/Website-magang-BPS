        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white border-0 py-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <form method="GET" action="{{ route('admin.kegiatan.index') }}" class="d-flex justify-content-end">
                            <div class="input-group" style="max-width: 350px;">
                                <input type="text" name="search" class="form-control" 
                                       placeholder="Cari kegiatan atau pelajar..." 
                            ...
                            <tbody>
                                @foreach($kegiatans as $index => $kegiatan)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div style="min-width: 0;">
                                                    ...
                                                    <small class="text-muted text-truncate d-block">{{ $kegiatan->user->email ?? '' }}</small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="text-truncate" style="max-width: 250px;" title="{{ $kegiatan->nama_kegiatan }}">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <p class="fw-semibold mb-0">{{ $kegiatan->user->name ?? 'N/A' }}</p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="text-muted small mb-1">Tanggal</label>
                                                            <p class="fw-semibold mb-0">{{ \Carbon\Carbon::parse($kegiatan->tanggal)->format('d F Y') }}</p>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <p class="mb-0" style="white-space: pre-wrap;">{{ $kegiatan->deskripsi ?? '-' }}</p>
                                                    </div>
                                                    <hr>
                                                    <div class="row mb-3">
                                                        <div class="col-md-4">
                                                            <label class="text-muted small mb-1">Volume</label>
                                                            <p class="mb-0">{{ $kegiatan->volume ?? '-' }} {{ $kegiatan->satuan ?? '' }}</p>
                                                        </div>
                                                        <div class="col-md-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <p class="mb-0 small">{{ $kegiatan->created_at->format('d M Y, H:i') }}</p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="text-muted small mb-1">Terakhir Diupdate</label>
                                                            <p class="mb-0 small">{{ $kegiatan->updated_at->format('d M Y, H:i') }}</p>
                                                        </div>
                                                    </div>
                                                </div>
