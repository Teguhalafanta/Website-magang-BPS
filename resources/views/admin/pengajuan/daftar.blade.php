        ...
        <table class="table table-bordered table-striped align-middle">
            ...
            <tbody>
                @forelse($pengajuans as $key => $p)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <button class="btn btn-sm btn-info" data-bs-toggle="modal"
                                data-bs-target="#detailModal{{ $p->id_pelajar }}" title="Lihat Detail">
                                <i class="bi bi-eye"></i>
                            </button>

                            <!-- Edit -->
                            <a href="{{ route('admin.pengajuan.edit', $p->id_pelajar) }}" class="btn btn-sm btn-warning"
                                title="Edit">
                                <i class="bi bi-pencil-square"></i>
                            </a>

                            <!-- Hapus -->
                            <form action="{{ route('admin.pengajuan.destroy', $p->id_pelajar) }}" method="POST"
                    ...
                    <!-- Modal Detail -->
                    <div class="modal fade" id="detailModal{{ $p->id_pelajar }}" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    {{-- Form Update Status --}}
                                    <form action="{{ route('admin.pengajuan.updateStatus', $p->id_pelajar) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
