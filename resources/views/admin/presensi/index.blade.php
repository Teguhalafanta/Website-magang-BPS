...
@section('content')
    <div class="container-fluid py-4">
                    ...
                    <div class="card-body py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h4 class="mb-0 fw-bold">{{ $presensis->whereIn('status', ['Alfa', 'Sakit'])->count() }}</h4>
                            </div>
        ...
        <ul class="nav nav-tabs mb-3" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="perpelajar-tab" data-bs-toggle="tab" data-bs-target="#perpelajar" type="button">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    @else
                                        <a href="{{ route('admin.presensi.index', ['today' => 1]) }}" class="btn btn-sm btn-primary">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <p class="fw-semibold mb-0">{{ $presensi->user->name ?? 'N/A' }}</p>
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="row mb-3">
                                                                <div class="col-6">
                                                                    ...
                                                                    <p class="mb-0">{{ \Carbon\Carbon::parse($presensi->tanggal)->format('d F Y') }}</p>
                                                                </div>
                                                                <div class="col-6">
                                                                    <label class="text-muted small mb-1">Hari</label>
                                                                    <p class="mb-0">{{ \Carbon\Carbon::parse($presensi->tanggal)->locale('id')->isoFormat('dddd') }}</p>
                                                                </div>
                                                            </div>
                                                            <div class="row mb-3">
                                                                <div class="col-6">
                                                                    <label class="text-muted small mb-1">Waktu Datang</label>
                                                                    <p class="mb-0">
                                                                        <span class="badge bg-light text-dark border">
                                                                            <i class="bi bi-clock me-1"></i>{{ \Carbon\Carbon::parse($presensi->waktu_datang)->format('H:i:s') }}
                                                                        </span>
                                                                    </p>
                                                                </div>
                                                                <div class="col-6">
                                                                    ...
                                                                    <p class="mb-0">
                                                                        @if($presensi->waktu_pulang)
                                                                            <span class="badge bg-light text-dark border">
                                                                                <i class="bi bi-clock me-1"></i>{{ \Carbon\Carbon::parse($presensi->waktu_pulang)->format('H:i:s') }}
                                                                            </span>
                                                                        @else
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="text-muted small mb-1">Status Kehadiran</label>
                                                                <p class="mb-0">
                                                                    <span class="badge bg-{{ $statusClass }}">
                                                                        {{ $presensi->status }}
                                                                    </span>
                                                            ...
                                                            <div class="small text-muted">
                                                                <p class="mb-1">
                                                                    <i class="bi bi-calendar-plus me-2"></i>Dicatat: {{ $presensi->created_at->format('d M Y, H:i') }}
                                                                </p>
                                                                @if($presensi->updated_at != $presensi->created_at)
                                                                    <p class="mb-0">
                                                                        <i class="bi bi-pencil me-2"></i>Diupdate: {{ $presensi->updated_at->format('d M Y, H:i') }}
                                                                    </p>
                                                                @endif
                                                            </div>
                                                        </div>
                                                                ...
                                                                <tbody>
                                                                    @foreach($data['presensis'] as $p)
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ \Carbon\Carbon::parse($p->waktu_datang)->format('H:i') }}</td>
