            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    <thead class="table-light" style="background-color: #e6f0ff !important;">
                        <tr>
                            <th class="py-3 px-4" style="color: #003d7a; border-bottom: 2px solid #0054a6;">
                            ...
                            <tr class="align-middle">
                                ...
                                <td class="px-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <strong class="d-block">{{ $item->user->pelajar->nama ?? $item->user->name }}</strong>
                                        ...
                                        <div class="modal fade" id="detailModal{{ $item->id }}" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header text-white" style="background-color: #0054a6;">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-12 mb-3">
                                                                ...
                                                                <p class="mb-0">{{ $item->user->pelajar->nama ?? $item->user->name }}</p>
                                                            </div>
                                                            <div class="col-12 mb-3">
                                    ...
                                    @else
                                        ...
                                        <form action="{{ route('admin.sertifikat.upload', $item->id) }}" method="POST" 
                                            ...
                                            <div class="d-flex flex-column gap-2">
                                                ...
                                                <div class="file-preview small text-muted text-center" id="preview-{{ $item->id }}" style="display: none;"></div>
                                            </div>
                                        </form>
                                    @endif
                                </td>
            ...
            <div class="card border-0 bg-light">
                <div class="card-body">
                    ...
                    <p class="card-text small mb-0">
                        ...
                        Sertifikat yang diupload harus dalam format PDF, DOC, JPG, atau PNG dengan ukuran maksimal 5MB.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 bg-light">
                <div class="card-body">
                    ...
                    <p class="card-text small mb-0">
                        ...
                        Sertifikat terkirim: <strong class="text-success">{{ $laporans->where('file_sertifikat', '!=', null)->count() }}</strong> | 
                        Menunggu: <strong class="text-warning">{{ $laporans->where('file_sertifikat', null)->count() }}</strong>
                    </p>
                </div>
            </div>
        </div>
