        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <h1 class="auth-title">Login Dosen</h1>
                    <p class="auth-subtitle mb-5">Silakan masuk menggunakan akun dosen pembimbing magang.</p>

                    <form method="POST" action="{{ route('login.dosen.store') }}">
                        @csrf
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class="text-gray-600">
                            Belum punya akun?
                            <a href="{{ route('register.dosen') }}" class="font-bold">Daftar di sini</a>.
                        </p>
                        <p><a href="#" class="font-bold">Lupa password?</a></p>
                    </div>
                </div>
            </div>
